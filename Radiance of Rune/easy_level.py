...
def easy_level(screen):
    ...
    def reset_game():
        ...
        velocity_y = 0
        blue_runes[:] = [
            pygame.Rect(310, 440, 40, 40), pygame.Rect(610, 380, 40, 40),
            pygame.Rect(910, 320, 40, 40), pygame.Rect(1210, 260, 40, 40),
            pygame.Rect(1510, 220, 40, 40), pygame.Rect(1800, 180, 40, 40),
            pygame.Rect(2100, 280, 40, 40), pygame.Rect(2400, 240, 40, 40),
            pygame.Rect(2700, 220, 40, 40), pygame.Rect(3000, 160, 40, 40)
        ]
        green_runes[:] = [pygame.Rect(2550, 240, 40, 40)]
        speed_boost = False
        on_ground = False
    ...
    platforms = [pygame.Rect(x, y, 180, 70) for x, y in [
        (300, 480), (600, 420), (900, 360), (1200, 300), (1500, 260),
        (1800, 220), (2100, 320), (2400, 280), (2700, 260), (3000, 200),
        (3300, 250), (3600, 200), (3900, 150), (4200, 100)
    ]]
    platforms.insert(0, pygame.Rect(0, HEIGHT - 170, 180, 70))
    ...
    horizontal_platform = MovingPlatform(4200, 300, 180, 70, range_x=150)
    moving_platforms = [horizontal_platform]
    platforms.append(pygame.Rect(4500, 200, 180, 70))

    blue_runes = []
    green_runes = []
    red_rune = pygame.Rect(1860, 170, 40, 40)
    gold_rune = pygame.Rect(4550, 160, 50, 50)
    enemy = pygame.Rect(2100, 272, 48, 48)
    enemy_direction = 1
    enemy_left = 2100
    enemy_right = 2100 + 180 - 48
    ...
    while True:
        ...
        if not game_over:
            ...
            if player.colliderect(red_rune) or player.colliderect(enemy):
                death_sound.play()
                death_animation = True
                death_timer = pygame.time.get_ticks()

            enemy.x += enemy_direction
            if enemy.x <= enemy_left or enemy.x >= enemy_right:
                enemy_direction *= -1
        ...
        screen.blit(rune_red_img, red_rune.move(-camera_x, 0))
        ...
        screen.blit(enemy_frames[(pygame.time.get_ticks() // 200) % len(enemy_frames)], enemy.move(-camera_x, 0))
